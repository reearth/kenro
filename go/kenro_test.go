...
const (
	...
	// A closed, outward-oriented unit cube as POLYHEDRALSURFACE Z: 3D area 6,
	// enclosed volume 1. Written as WKB because kenro's WKT reader refuses Z.
	cubeZ = `x''`
...
var smokeCases = []smokeCase{
	...
	// The two SFCGAL measurements. A surface is not a solid in SFCGAL, which is
	// why the volume wears a kenro_ name — see docs/3d.md.
	{"ST_3DArea", `ST_3DArea(` + cubeZ + `)`, 6.0},
	{"kenro_volume", `kenro_volume(` + cubeZ + `)`, 1.0},
	...
	{"ST_Split", `ST_Area(ST_Split(ST_GeomFromText('POLYGON((0 0,10 0,10 10,0 10,0 0))'), ST_GeomFromText('LINESTRING(5 -1,5 11)')))`, 100.0},
