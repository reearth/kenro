...
"ST_MultiPolyFromWKB/1": {
  ...
  // Same unit-square patch: its 3D area is 1, and unlike ST_Area (which
  // measures the planar shadow) this one is SFCGAL's number in PostGIS.
  "ST_3DArea/1": {
    sql: "SELECT ST_3DArea(x'')",
    check: (v) => Number(v) === 1,
  },
  // kenro_volume needs a *closed* shell, so this one is the unit cube:
  // six patches, enclosed volume 1.
  "kenro_volume/1": {
    sql: "SELECT kenro_volume(x'')",
    check: (v) => Math.abs(Number(v) - 1) < 1e-9,
  },
